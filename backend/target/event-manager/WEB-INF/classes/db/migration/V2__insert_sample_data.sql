...
-- Insert sample allergens (global)
...
-- Insert event-specific allergens
INSERT INTO allergens (name, description, severity, event_id) VALUES
...
(1, 1), -- Emma har glutenallergi
(1, 2), -- Emma har laktosintolerans
(2, 3), -- Oscar har nötallergi
(3, 4), -- Maja har äggallergi
(5, 1), -- Alice har glutenallergi
(5, 5), -- Alice har sojaallergi
(6, 7); -- Hugo har skaldjursallergi
...
(1, 2, 'CONFIRMED', '2026-01-11 14:30:00', '2026-01-12 08:00:00', NULL),
(1, 3, 'PENDING', '2026-01-15 09:15:00', NULL, 'Väntar på betalning'),
(1, 4, 'CONFIRMED', '2026-01-08 16:00:00', '2026-01-09 10:00:00', 'Spelar trumpet'),
(1, 5, 'WAITLIST', '2026-01-20 11:00:00', NULL, 'Ställ i kö om plats finns'),
(2, 1, 'CONFIRMED', '2026-02-01 10:00:00', '2026-02-02 09:00:00', NULL),
(2, 6, 'CONFIRMED', '2026-02-05 14:00:00', '2026-02-06 08:00:00', 'Tar med egen tältutrustning');
